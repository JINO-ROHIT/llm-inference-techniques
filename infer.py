...
from qwen import Qwen3Model, QWEN3_CONFIG
...
def greedy_infer(input_token_ids: list, max_tokens: int = 500, eos_token_id: tuple = (151645, 151643), stream = False):
...
_, stats = greedy_infer(input_token_ids)
print(stats)
